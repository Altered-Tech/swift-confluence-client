...
public struct BlogPostVersion: Codable {
    ...
    public init(createdAt: Date? = nil, message: String? = nil, number: Int? = nil, minorEdit: Bool? = nil, authorId: String? = nil, blogpost: VersionedEntity? = nil) {
