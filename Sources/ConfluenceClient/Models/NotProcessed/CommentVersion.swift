...
public struct CommentVersion {
    ...
    public init(createdAt: Date? = nil, message: String? = nil, number: Int? = nil, minorEdit: Bool? = nil, authorId: String? = nil, comment: VersionedEntity? = nil) {
