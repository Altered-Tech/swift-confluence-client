...
public struct PageVersion {
    ...
    public init(createdAt: Date? = nil, message: String? = nil, number: Int? = nil, minorEdit: Bool? = nil, authorId: String? = nil, page: VersionedEntity? = nil) {
