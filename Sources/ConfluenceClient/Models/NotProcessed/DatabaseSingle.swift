...
public struct DatabaseSingle: Codable {
    ...
    public init(_id: String? = nil, type: String? = nil, status: ContentStatus? = nil, title: String? = nil, parentId: String? = nil, parentType: ParentContentType? = nil, position: Int? = nil, authorId: String? = nil, ownerId: String? = nil, createdAt: Date? = nil, version: Version? = nil, links: DatabaseLinks? = nil) {
        self._id = _id
        self.type = type
        self.status = status
        self.title = title
